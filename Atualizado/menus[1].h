...
void menuOperacoes(){
    printf("\n\t\t1.Quantos livros foram vendidos num dado per�odo de tempo \n");
    printf("\t\t2.Determinar a data da �ltima compra/venda de um dado livro\n");
    printf("\t\t3.Determinar quantos livros um dado cliente j� comprou(Feito)\n");
    printf("\t\t4.Mostrar os K livros mais recentes de uma dada �rea Cient�fica\n");
    printf("\t\t5.Mostrar os K livros mais vendidos num dado per�odo \n");
    printf("\t\t6.Determinar a �rea Cient�fica com mais livros\n");
    printf("\t\t7.Determinar qual o Cliente com mais livros comprados(Feito)\n");
    printf("\t\t8.Mostrar os Clientes por ordem decrescente do n�mero de compras(Feito)\n");
    printf("\t\t9.Determinar o Ano com mais publica��es\n");
    printf("\t\t10.Calcular o cliente que mais gastou(Feito)\n");
    printf("\t\t11.Determinar o desperd�cio de mem�ria (no caso em que por exemplo num livro, no campo TITULO tenham char TITULO[100], se os TITULOS forem mais pequenos existe muito desperd�cio\n\n");
