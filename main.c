              ...
              printf("\n\n");
                ...
                switch(s2){
                    ...
                    case 2:   
                        ...
                        if(ver_ex(pl2,contador2,o) == 1){ //VE SE EXISTE O CLIENTE
                          Cliente clienteaux;
               ...
               menuEncomendas();
                ...
                switch(s4){
                    case 1:
                          ...
                          int op=0;
                          PNodo ListaLivrosAuxiliar = Criar();
                          liv1 = (Livro*) malloc (sizeof(Livro)*contagemLivros);
                          criarVetorPelaLista(Livros,liv1,&contagemLivros);                          
                          Listar(Livros);
